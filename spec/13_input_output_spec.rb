...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      subject(:game_not_end) { described_class.new(5, '6') }
  ...
  describe '#verify_input' do
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        user_input = 'k'
        verified_input = game_check.verify_input(user_input)
        expect(verified_input).to equal(nil)
      end
    end
  end
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        invalid_input = 'a'
        valid_input = '8'
        allow(game_loop).to receive(:player_input).and_return(invalid_input, invalid_input, valid_input)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      ...
      it 'outputs correct phrase' do
        ...
        expect { game_three.final_message }.to output(output_phrase).to_stdout
      end
    end
  end
end
